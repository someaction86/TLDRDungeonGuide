        ...
        bosses = {
            {
                ...
                tldr = {
                    "REFUELING PROTOCOL at 0 energy: soak Energy Orbs before they reach the boss or the group takes heavy hits.",
                    "ARCANE WAVE: drops puddles under players — stack them on the edges.",
                    "ETHEREAL BONDS: roots several players and ticks damage — Magic dispel immediately.",
                },
                tank = {
                    "REPULSING SLAM: hard knockback — use a wall or staircase to block it. Pop a defensive.",
                    "Reposition boss constantly to keep puddles stacking on the edges, not the center.",
                    "Pre-position near where orbs will spawn so you can quickly react to soak.",
                },
                healer = {
                    "ETHEREAL BONDS roots multiple players and ticks damage — this is your highest dispel priority.",
                    "ARCANE WAVE hits the whole group — be ready for coordinated puddle drops and position resets.",
                    "Orb soaks give players Unstable Energy stacks — watch for anyone who soaked too many.",
                },
                dps = {
                    "At 0 energy: stop DPS and pre-position to soak orbs. Assign soakers before the pull.",
                    "Don't soak orbs with high Unstable Energy stacks — let them drop between soak windows.",
                    "Help dispel ETHEREAL BONDS if you have a magic dispel.",
                },
            },
            {
                name = "Seranel Sunlash",
                tldr = {
                    "HASTENING WARD: purge the boss's magic buff immediately or his damage spikes dangerously.",
                    "WAVE OF SILENCE: step into the Suppression Zone before the cast completes or you get pacified for 8s.",
                    "Move boss OUT of the Suppression Zone so the group can freely stand in it.",
                },
                tank = {
                    "HASTENING WARD dramatically increases boss damage to you — pop a defensive if you cannot purge in time.",
                    "Keep the boss away from the Suppression Zone so the group has clear access to it.",
                    "After his death, tank the Void mobs from the Cynosure of Twilight — they have Void Gash, watch shadow damage.",
                },
                healer = {
                    "If WAVE OF SILENCE lands on the group, you are silenced too — time your big heals BEFORE the cast completes.",
                    "Pre-position inside the Suppression Zone whenever the cast begins so you maintain heal access.",
                    "HASTENING WARD phases spike incoming tank damage — keep the tank topped while purges land.",
                },
                dps = {
                    "Assign a purger for HASTENING WARD before pulling — it needs to come off immediately every time.",
                    "Watch the WAVE OF SILENCE cast bar and move into the Suppression Zone before it ends.",
                    "Interrupt Polymorph on the Void mobs that spawn after the boss dies.",
                },
            },
            {
                name = "Gemellus",
                tldr = {
                    "BEFORE PULL: one player per quadrant of the arena — this is mandatory or the fight wipes instantly.",
                    "At 50%: copies spawn with shared health — stack boss near copies and cleave all together.",
                    "COSMIC STING: dodge void zones. ASTRAL GRIP pulls players INTO them — keep space clear.",
                },
                tank = {
                    "Hold the boss near his copies so the group can cleave all together.",
                    "Move the boss proactively away from COSMIC STING zones — don't react, anticipate.",
                    "SYNAPTIC NEXUS: position boss next to copies to maximize splash.",
                },
                healer = {
                    "The copy phase at 50% spikes group-wide damage — be ready with a defensive cooldown.",
                    "Players dragged into void zones by ASTRAL GRIP take heavy damage — prioritize them.",
                },
                dps = {
                    "Pre-fight: assign quadrant positions before the pull. Everyone must be in their quadrant.",
                    "At 50%: immediately pivot to cleaving all copies — they share health so all damage counts.",
                    "Avoid COSMIC STING void zones — ASTRAL GRIP will pull you into them if you stand near them.",
                },
            },
            {
                name = "Degentrius",
                tldr = {
                    "UNSTABLE VOID ESSENCE: spread out so the bouncing orb only touches the intended target.",
                    "VOID TORRENT: lasers across the arena floor — never cross the beams.",
                    "VOID ERUPTION: AoE burst centered on boss — move away at cast start.",
                },
                tank = {
                    "VOID ERUPTION originates from the boss — tank drag him away from the group during the cast or rotate out.",
                    "Position boss so Void Torrent beams have predictable paths the group can navigate.",
                    "Hold aggro during orb bounces — the boss may change targets briefly.",
                },
                healer = {
                    "VOID ERUPTION is group-wide unavoidable burst — your main cooldown window.",
                    "Players hit by bouncing Unstable Void Essence orbs take repeated hits — top them between bounces.",
                    "Watch the whole group during Void Torrent — players crossing beams spike hard.",
                },
                dps = {
                    "Spread out for UNSTABLE VOID ESSENCE so orbs bounce only to their target, not the whole group.",
                    "Never cross VOID TORRENT beams — plan your position before they activate.",
                    "Move away from boss on VOID ERUPTION cast start.",
                },
            },
        },
    },
        ...
        bosses = {
            {
                ...
                tldr = {
                    "EVEN DAMAGE: keep both bosses within 10% HP — if one dies far ahead, the survivor enrages.",
                    "FREEZING TRAP: cluster all traps together in one corner to keep the arena clear.",
                    "BINDING CHAIN: move between the chained player and Muro'jin to break the tether.",
                },
                tank = {
                    "Tank both bosses separately but track their HP constantly — call out if one is pulling ahead.",
                    "On NEKRAXX DIVE: be ready to reposition after the swoop lands.",
                    "BINDING CHAIN: move between chained allies and Muro'jin to break the tether.",
                },
                healer = {
                    "Coordinate with DPS to track HP percentages — call out if damage is becoming uneven.",
                    "NEKRAXX DIVE hits random players — spot heal whoever gets hit.",
                    "BINDING CHAIN ticks damage on the rooted player — prioritize them while others break it.",
                },
                dps = {
                    "Assign one DPS per boss before pulling — communicate HP percentages constantly.",
                    "Stack all FREEZING TRAP locations in one corner — don't drop them randomly.",
                    "When you see BINDING CHAIN, move between the chained player and Muro'jin immediately.",
                },
            },
            {
                name = "Vordaza",
                tldr = {
                    "CRUSH SOULS: marked players cluster near a Soulbind Totem — stay 3yds BACK from the totem.",
                    "SOULBIND TOTEMS: cleave through them but maintain 3yd distance or get soul-sapped.",
                    "NECROTIC HARVEST: interruptible channel — stop this every cast.",
                },
                tank = {
                    "Face boss away from the group. Watch for NECROTIC HARVEST cast and call for interrupts.",
                    "On CRUSH SOULS: move yourself and the boss so the marked players can cluster near a totem.",
                    "Keep exactly 3yds of distance from Soulbind Totems while cleaving — use your positioning indicators.",
                },
                healer = {
                    "CRUSH SOULS marks spike incoming damage — be ready to heal the cluster of marked players.",
                    "NECROTIC HARVEST raises dead mobs — if it lands, the extra adds will spike your work significantly.",
                    "Soul-sap debuff from totem proximity reduces healing received — watch debuffed players closely.",
                },
                dps = {
                    "Interrupt NECROTIC HARVEST every single cast — this is a top priority.",
                    "On CRUSH SOULS: move to the marked cluster near a totem, staying 3 yards from the totem itself.",
                    "Cleave Soulbind Totems down but don't walk up to them — stay at edge of melee range.",
                },
            },
            {
                name = "Rak'tul, Vessel of Souls",
                tldr = {
                    "FREE PRISONERS before engaging — if you pull without freeing them, Rak'tul sacrifices them for extra power.",
                    "LOST SOUL ADDS: kite or CC them — do not let them reach the group.",
                    "RITUAL SACRIFICE: use Freedom, immunity, or Roar of Sacrifice on the targeted player.",
                },
                tank = {
                    "SOUL REND: major defensive every time — it also AoEs nearby so move boss away from group during cast.",
                    "Pick up LOST SOUL ADDS immediately — they drain health on contact if they reach players.",
                    "Stay between Rak'tul and any freed prisoner positions so adds stay on you.",
                },
                healer = {
                    "RITUAL SACRIFICE: call for the target to use an immunity — if they can't, be ready for a massive heal.",
                    "SOUL REND AoEs the group — raid healing cooldown if it overlaps with add pressure.",
                    "Track the LOST SOUL ADDS — each one draining a player compounds your healing significantly.",
                },
                dps = {
                    "Pre-fight: interact with and free every troll prisoner before pulling Rak'tul.",
                    "LOST SOUL ADDS: kite away from them, CC them, or kill them — never let them drain the group.",
                    "Have a Freedom or immunity ready for RITUAL SACRIFICE — communicate who is using it.",
                },
            },
        },
    },
        ...
        bosses = {
            {
                name = "Emberdawn",
                tldr = {
                    "FLAMING UPDRAFT: drop the AoE at the platform edges, not center.",
                    "BURNING GALE intermission: stay clustered near center. SCORCHING DIVE: dodge the trajectory.",
                },
                tank = {
                    "Hold Emberdawn centered so players marked with FLAMING UPDRAFT have clear edge access.",
                    "During BURNING GALE stay clustered — the platform shrinks and you need to maintain boss control.",
                    "WING BUFFET tank buster: defensive every time.",
                },
                healer = {
                    "BURNING GALE is intermission raid damage — this is your main healing cooldown window.",
                    "Players moving to edges for FLAMING UPDRAFT are briefly out of optimal heal range — track them.",
                    "Keep everyone topped before each BURNING GALE cast.",
                },
                dps = {
                    "FLAMING UPDRAFT: immediately run to the edge and drop the AoE there. Return to boss after.",
                    "During BURNING GALE: stop moving away and cluster near the boss at the center.",
                    "SCORCHING DIVE: watch for the targeting trajectory and sidestep.",
                },
            },
            {
                name = "Derelict Duo (Kalis and Latch)",
                tldr = {
                    "SHARED HEALTH: keep damage even on both. Latch's HEAVING YANK interrupts Kalis's SHRIEK.",
                    "Coordinate: be near Kalis when Latch yanks so the pull naturally stops the Shriek.",
                },
                tank = {
                    "Tank both close together for efficient cleave.",
                    "CHAIN WHIRL: step away from Latch during the spin.",
                    "Anticipate HEAVING YANK and be positioned so the pull lands near Kalis's cast position.",
                },
                healer = {
                    "KALIS SHRIEK if uninterrupted: group-wide disorient — this is your emergency cooldown.",
                    "Track both HP bars — uneven damage means longer fight and more sustained damage intake.",
                    "CHAIN WHIRL hits nearby players — stand away from Latch during this ability.",
                },
                dps = {
                    "Assign one DPS per boss to keep damage even — communicate HP percentages.",
                    "When Latch uses HEAVING YANK: make sure you are near Kalis so the pull positions you to interrupt Shriek.",
                    "KALIS SHRIEK must be stopped — coordinate backup interrupts if Heaving Yank is on cooldown.",
                },
            },
            {
                name = "Commander Kroluk",
                tldr = {
                    "RECKLESS LEAP: furthest player gets charged — designated player stays at max range with defensive ready.",
                    "INTIMIDATING SHOUT: stack together before it fires so all fears land and break simultaneously.",
                    "ADD PHASES at 66% and 33%: stop DPS on boss and clean up adds fully before resuming.",
                },
                tank = {
                    "Stay at max range during RECKLESS LEAP windows to reliably be the charge target.",
                    "Grab all adds immediately at 66% and 33% — loose adds during the main fight are dangerous.",
                    "BATTLE RAGE enrage at low HP: defensive + call for healer cooldown.",
                },
                healer = {
                    "RECKLESS LEAP target takes a big hit plus leaves a fire ring — top them quickly.",
                    "INTIMIDATING SHOUT: everyone is feared briefly — use instant heals during the fear.",
                    "Add phases at 66% and 33% spike damage — save a cooldown for the second add phase.",
                },
                dps = {
                    "Designate the RECKLESS LEAP target before pulling — that player stays at max range with a personal defensive ready.",
                    "Stack together just before INTIMIDATING SHOUT so fears land together and the group recovers as one.",
                    "Stop DPS at 66% and 33% and fully clear adds before resuming on Kroluk.",
                },
            },
            {
                name = "The Restless Heart",
                tldr = {
                    "BOLT GALE: move constantly — standing still means taking multiple hits.",
                    "BULLSEYE WINDBLAST: jump over the expanding ring as it reaches you.",
                    "TEMPEST SHIELD: interrupt and dispel to strip the boss's damage reduction.",
                },
                tank = {
                    "GUST STRIKE: defensive and have a gap closer ready — the knockback will send you flying.",
                    "Keep boss facing away from group during BOLT GALE sweeps.",
                    "Strip TEMPEST SHIELD quickly — every second it's up is lost DPS.",
                },
                healer = {
                    "STORM SURGE ramps throughout the fight — save your bigger cooldowns for the final 20% when it peaks.",
                    "Players hit by BOLT GALE who weren't moving take multiple stacks — keep everyone mobile with reminders.",
                    "BULLSEYE WINDBLAST: heal the targeted player through the ring impact before they jump.",
                },
                dps = {
                    "Never stop moving during BOLT GALE volleys — constant movement means only occasional hits.",
                    "BULLSEYE WINDBLAST: time your jump to clear the expanding ring. Practice the timing early in the fight.",
                    "Interrupt and dispel TEMPEST SHIELD every single time it goes up — treat it like a priority interrupt.",
                },
            },
        },
    },
...
local preseasonDungeons = {
    {
        ...
        bosses = {
            ...
            },
            {
                name = "Nalorakk",
                tldr = {
                    "TROLL FORM: interrupt SURGE OF POWER every cast — it is the highest-priority interrupt.",
                    "BEAR FORM: frontal cleave + bleed on tank. Interrupt cooldowns can rest during Bear Form.",
                    "Track form transitions — Bear Form = physical threat, Troll Form = interrupt everything.",
                },
                tank = {
                    "BEAR FORM: face boss away from group. MANGLE stacks bleed — use a defensive at high stacks and call for dispel.",
                    "CHARGE in Bear Form will sometimes target non-tanks — stay near marked players to re-intercept.",
                    "In Troll Form: SURGE OF POWER is interruptible — call it out so DPS focus their kicks.",
                },
                healer = {
                    "MANGLE bleed stacks on tank during Bear Form — prioritize tank and dispel when possible.",
                    "SURGE OF POWER if uninterrupted: heavy group damage — emergency cooldown.",
                    "CHARGE targets random players — keep everyone topped before Bear Form transitions.",
                },
                dps = {
                    "SURGE OF POWER is a Troll Form cast — interrupt every single one. Run a rotation.",
                    "CHARGE in Bear Form: the targeted player use a personal defensive.",
                    "Form tracking: Bear Form = free interrupt cooldown recovery, Troll Form = kick rotation active.",
                },
            },
        },
    },
        ...
        bosses = {
            {
                name = "Arcanotron Custos",
                tldr = {
                    "0 energy: soak Energy Orbs. ARCANE PUDDLES: stack on edges. ETHEREAL BONDS: Magic dispel immediately.",
                    "REPULSING SLAM (tank): use a wall to block the knockback.",
                },
                tank = {
                    "REPULSING SLAM: position with a wall behind you to block the knockback. Pop a defensive.",
                    "Reposition boss constantly toward the edges so puddle drops stay out of center.",
                    "Pre-position near orb spawn locations before 0-energy windows.",
                },
                healer = {
                    "ETHEREAL BONDS: top-priority dispel — it roots multiple players and ticks damage.",
                    "Orb soaks give UNSTABLE ENERGY stacks — monitor and dispel players with high counts.",
                    "ARCANE WAVE group hit: moderate healing, the main concern is repositioning after.",
                },
                dps = {
                    "0 energy: stop DPS and pre-position to soak orbs. Assign soakers.",
                    "Don't chain soak with high UNSTABLE ENERGY stacks — let them drop.",
                    "Help dispel ETHEREAL BONDS if you have a magic dispel.",
                },
            },
            {
                name = "Seranel Sunlash",
                tldr = {
                    "HASTENING WARD: purge immediately. WAVE OF SILENCE: step into Suppression Zone before cast ends.",
                    "Keep boss OUT of the Suppression Zone — the group needs free access to it.",
                },
                tank = {
                    "HASTENING WARD spikes your damage intake — pop a defensive if purge is late.",
                    "Keep boss away from the Suppression Zone at all times.",
                    "After the boss dies, tank the Void adds — they have Void Gash extra shadow damage.",
                },
                healer = {
                    "Pre-position in the Suppression Zone during WAVE OF SILENCE cast — you need to keep casting.",
                    "Time big heals BEFORE the silence lands during non-suppression-zone windows.",
                    "HASTENING WARD phases = higher tank damage incoming — stay ahead of it.",
                },
                dps = {
                    "Assign a dedicated purger for HASTENING WARD before the pull.",
                    "Move into Suppression Zone before WAVE OF SILENCE completes — watch the cast bar.",
                    "After boss: interrupt Polymorph on the Void mobs from the Cynosure.",
                },
            },
            {
                name = "Gemellus",
                tldr = {
                    "PRE-PULL: one player per quadrant — mandatory or instant wipe.",
                    "50%: copies spawn with shared health — cleave all together.",
                    "ASTRAL GRIP pulls players into COSMIC STING zones — keep the arena clear.",
                },
                tank = {
                    "Hold boss near copies at 50% for cleave efficiency.",
                    "Proactively move boss away from COSMIC STING void zones — don't wait to react.",
                    "SYNAPTIC NEXUS: maximize splash by keeping boss near copies.",
                },
                healer = {
                    "Copy phase at 50% = spike group damage window — defensive cooldown here.",
                    "Players pulled into void zones by ASTRAL GRIP take heavy burst damage — priority heal.",
                },
                dps = {
                    "Pre-fight: sort quadrant positions. Everyone MUST be in their quadrant before pull.",
                    "50%: pivot to cleaving all copies immediately — shared health, all damage counts.",
                    "ASTRAL GRIP will pull you into COSMIC STING zones if you stand near them — give them wide berth.",
                },
            },
            {
                name = "Degentrius",
                tldr = {
                    "UNSTABLE VOID ESSENCE: spread out so bouncing orb only hits the intended player.",
                    "VOID TORRENT beams: never cross them. VOID ERUPTION: move away from boss at cast start.",
                },
                tank = {
                    "During VOID ERUPTION: drag boss away from the group cluster — it originates from his position.",
                    "Position boss so VOID TORRENT beams have predictable paths the group can plan around.",
                },
                healer = {
                    "VOID ERUPTION is unavoidable group burst — your main cooldown window every time.",
                    "Players crossing VOID TORRENT beams spike hard — keep everyone topped before beam phases.",
                },
                dps = {
                    "Spread for UNSTABLE VOID ESSENCE bouncing orbs — one player per orb trajectory.",
                    "Never cross VOID TORRENT beams — plan your position during the setup phase.",
                    "Move away from boss on VOID ERUPTION cast.",
                },
            },
        },
    },
        ...
        bosses = {
            {
                name = "Emberdawn",
                tldr = {
                    "FLAMING UPDRAFT: drop at platform edges immediately. BURNING GALE: cluster near center.",
                    "SCORCHING DIVE: dodge the trajectory. WING BUFFET (tank): defensive every time.",
                },
                tank = { "See Season 1 Windrunner Spire — same boss, same mechanics." },
                healer = { "See Season 1 Windrunner Spire — same boss, same mechanics." },
                dps = { "See Season 1 Windrunner Spire — same boss, same mechanics." },
            },
            {
                name = "Derelict Duo (Kalis & Latch)",
                tldr = { "See Season 1 Windrunner Spire — same boss, same mechanics." },
                tank = { "See Season 1 Windrunner Spire — same boss, same mechanics." },
                healer = { "See Season 1 Windrunner Spire — same boss, same mechanics." },
                dps = { "See Season 1 Windrunner Spire — same boss, same mechanics." },
            },
        ...
        bosses = {
            {
                ...
                tldr = { "See Season 1 Maisara Caverns — same boss, same mechanics." },
                tank = { "See Season 1 Maisara Caverns — same boss, same mechanics." },
                healer = { "See Season 1 Maisara Caverns — same boss, same mechanics." },
                dps = { "See Season 1 Maisara Caverns — same boss, same mechanics." },
            },
            {
                name = "Vordaza",
                tldr = { "See Season 1 Maisara Caverns — same boss, same mechanics." },
    ...
    },
    {
        ...
        bosses = {
            {
                name = "Chief Corewright Kasreth",
                tldr = { "See Season 1 Nexus Point Xenas — same boss, same mechanics." },
                tank = { "See Season 1 Nexus Point Xenas — same boss, same mechanics." },
                healer = { "See Season 1 Nexus Point Xenas — same boss, same mechanics." },
                dps = { "See Season 1 Nexus Point Xenas — same boss, same mechanics." },
            },
            {
                name = "Corewarden Nysarra",
                tldr = { "See Season 1 Nexus Point Xenas — same boss, same mechanics." },
